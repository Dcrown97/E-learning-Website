        ...
        <div class="admin-dashboard-right-side">
                            ...
                            @foreach ($instructor_course as $course)
                                <div class="col-lg-6">
                                    <div class="single-course-wrap media">
                                        <div class="thumb"
                                            style="background-image: url(assets/img/lesson/2.png);">
                                        </div>
            ...
            <div class="dashboard-left-menu">
                ...
                <ul>
                    ...
                    <li class="nav-item">
                        <a class="dashboard-item-menu" href="instructorCourse"><i
                                class="fas fa-graduation-cap"></i>Total Courses</a>
                    </li>
                    <li class="nav-item">
                        <a class="dashboard-item-menu" href="instructorStudent"><i
                                class="fas fa-user-graduate"></i>Total Students</a>
                    </li>
                    <li class="nav-item">
