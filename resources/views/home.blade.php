        ...
        <div class="container">
            ...
            <div class="row row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
                ...
                <div class="col-md mb-md-6 mb-4 px-2">
                    <!-- Card -->
                    <a href="/course/{{base64_encode($category->id)}}"
                        class="card card-border-hover border icon-category icon-category-sm p-5 lift shadow-dark-hover">
                        <!-- Image -->
                        <div class="row align-items-center mx-n3">
                            ...
                            <div class="col px-3">
                                ...
                                <div class="card-body p-0">
                                    <h6 class="mb-0 line-clamp-1">{{$category->name}}</h6>
        ...
        <div class="container">
            ...
            <nav class="nav justify-content-center mb-6 tab-nav">
                <div class="nav justify-content-lg-start justify-content-xl-center justify-content-center tab-nav-1" id="pills-tab" role="tablist">
                     ...
                     @foreach ($categories as $category)
                        <a class="btn-sm btn-pill me-1 mb-1 text-dark fw-medium px-6" id="pills-{{$category->name}}-tab" data-bs-toggle="tab" href="#pills-{{$category->name}}" role="tab" aria-controls="pills-{{$category->name}}" aria-selected="false">
                           {{$category->name}}
                        </a>
                        @endforeach
                     @endif
                      ...
                      <div class="col-12 col-md-6 col-xl-4 col-wd-3 pb-4 pb-md-7" style="padding-right:15px;padding-left:15px;">
                          ...
                          <div class="card border shadow p-2 rounded-lg sk-fade">
                              ...
                              <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                  ...
                                  <!-- Preheading -->
                                  <a href="course-single-v5.html"><span class="mb-1 d-inline-block text-gray-800">{{$course->title}}</span></a>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer px-3 pt-4 pb-1">
                                <a href="instructors-single.html" class="d-block">
                                    <h5 class="mb-0">{{ $lectures['Firstname'] }} {{ $lectures['Lastname'] }}
                                    </h5>
                                </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-4 mb-md-0" style="margin: 0 auto;">
                    <!-- Card -->
                    <div class="card border lift">
                        <div class="card-body p-7 px-lg-10 py-lg-9">
                            <h3 class="font-size-xl">Become an Instructor</h3>
                            <p class="mb-5 text-capitalize">Teach what you love. Dove Schooll gives you the tools to create
                                an online course.</p>
                            <a href="instructorsignup" class="btn btn-tropaz btn-pill btn-x-wide lift">START TEACHING</a>
                        </div>
                    </div>
                </div>
            </div>
