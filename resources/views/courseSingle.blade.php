            ...
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                ...
                <div class="d-md-flex align-items-center mb-5">
                    <div class="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6">
                        <div class="p-2">
                            <img src="/assets/img/avatars/avatar-1.jpg" alt="..." class="rounded-circle" width="68"
                                height="68">
                        </div>
                    </div>
                ...
                <div id="Overview" class="mb-8">
                    <ul class="nav course-tab-v1 border-bottom h4 mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#Reviews" data-bs-toggle="smooth-scroll"
                    ...
                    <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                       ...
                       @if(!$paid)
                        @if(Auth::check()->type =="student")
                            <button onclick="payWithPaystack()" id="buynow" class="btn btn-orange btn-block mb-6" type="button" name="button">ENROLL</button>
                        
                        @elseif(Auth::check()->type =="instructor" || Auth::check()->type =="admin")
                            <button id="buynow" class="btn btn-orange btn-block mb-6" type="button" name="button"> {{Auth::user()->type}}</button>
                        @else
                        <a href="/studentsignup/{{ base64_encode($course->id) }}" id="buynow" class="btn btn-primary btn-block mb-3"
                            type="button" name="button"> BUY NOW</a>
                        @endif
                ...
                <div class="d-block">
                    <div class="border rounded px-6 px-lg-5 px-xl-6 pt-5 shadow">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="/assets/img/photos/photo-16.jpg" alt="..."
                                        class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-single-v5.html" class="d-block">
    ...
    <script>
        ...
        function payWithPaystack() {
            var handler = PaystackPop.setup({
                key: 'pk_test_fd4c241bcb811f50ac1a86c65663afb7b247ad45',
                email: "@php echo Auth::user()->email @endphp",
                amount: @php echo $course->price *100 @endphp,
                currency: "NGN",
                ...
                callback: function(response) {
                    ...
                    let payload = {
                        response, 
                        "course_id" : @php echo $course->id @endphp,
                        "student_id" : "@php echo Auth::user()->id @endphp",
                        "instructor_id": @php echo $course->user_id @endphp,
                        "amount_paid": @php echo $course->price @endphp
                    }
                    console.log('our own', payload);
                    $.ajaxSetup({
                        headers: {
