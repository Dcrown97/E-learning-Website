    ...
    <section class="admin-dashboard-section">
        <div class="admin-dashboard-right-side">
           ...
           <div class="dashboard-profile-area">
                ...
                <ul>
                    <li><span>Registration Date</span>{{$admins->created_at}}</li>
                    <li><span>First Name</span>{{$admins->Firstname}}</li>
                    <li><span>Last Name</span>{{$admins->Lastname}}</li>
                    <li><span>Uasername</span>{{$admins->Username}}</li>
                    <li><span>Email</span>{{$admins->email}}</li>
                    <li><span>Phone Number</span>{{$admins->Number}}</li>
