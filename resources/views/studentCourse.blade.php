    ...
    <section class="admin-dashboard-section">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="single-course-wrap media">
                                    <div class="thumb" style="background-image: url(assets/img/lesson/2.png);">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="single-course-wrap media">
                                    <div class="thumb" style="background-image: url(assets/img/lesson/3.png);">
                                    </div>
                                    <div class="wrap-details">
                                        <h6><a href="#">PHP for Beginners - Become a PHP Master - CMS Project</a></h6>
                                        <div class="user-area">
                            ...
                            <div class="col-lg-6">
                                <div class="single-course-wrap media">
                                    <div class="thumb" style="background-image: url(assets/img/course/4.png);">
                                    </div>
                                    <div class="wrap-details">
                                        <h6><a href="#">PHP for Beginners - Become a PHP Master - CMS Project</a></h6>
                                        <div class="user-area">
                            ...
                            <div class="col-lg-6">
                                <div class="single-course-wrap media">
                                    <div class="thumb" style="background-image: url(assets/img/course/5.png);">
                                    </div>
                                    <div class="wrap-details">
                                        <h6><a href="#">PHP for Beginners - Become a PHP Master - CMS Project</a></h6>
                                        <div class="user-area">
                            ...
                            <div class="col-lg-6">
                                <div class="single-course-wrap media">
                                    <div class="thumb" style="background-image: url(assets/img/course/6.png);">
                                    </div>
                                    <div class="wrap-details">
                                        <h6><a href="#">PHP for Beginners - Become a PHP Master - CMS Project</a></h6>
                                        <div class="user-area">
                            ...
                            <div class="col-lg-6">
                                <div class="single-course-wrap media">
                                    <div class="thumb" style="background-image: url(assets/img/course/7.png);">
                                    </div>
                                    <div class="wrap-details">
                                        <h6><a href="#">PHP for Beginners - Become a PHP Master - CMS Project</a></h6>
                                        <div class="user-area">
        ...
        <div class="dashboard-left-menu">
            ...
            <ul>
                ...
                <li class="nav-item">
                    <a class="dashboard-item-menu" href="enrolledCourses"><i class="fas fa-graduation-cap"></i>Enrolled Courses</a>
                </li>
                <li class="nav-item">
