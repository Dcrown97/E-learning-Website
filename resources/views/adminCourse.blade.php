            ...
            <div class="dashboard-course-area">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="row">
                            @foreach ($admin_course as $course)
                                <div class="col-lg-6">
                                    <div class="single-course-wrap media">
                                        ...
                                        <div class="wrap-details">
                                            ...
                                            <div class="col-sm-12">
                                                <a class="badge {{ $course->featured == 'yes' ? 'featured' : 'not_featured' }}"
                                                    href="/featured/{{ base64_encode($course['id']) }}">{{ $course->featured == 'yes' ? 'Featured' : 'Not Featured' }}</a>
                                            </div>
